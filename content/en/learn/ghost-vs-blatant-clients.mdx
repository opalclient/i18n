...
**When to use blatant:**
- Servers with anticheats you can bypass (Hypixel, etc.)
...
- Blatant Hypixel bypasses (kill aura, speed, flight, scaffold)
...
|----------|-------------|
| Hypixel Bedwars/Skywars | Blatant (with bypasses) |
